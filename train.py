...
train_set = TrainDatasetFromFolder('data/train1', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
val_set = ValDatasetFromFolder('data/val1', upscale_factor=UPSCALE_FACTOR)
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    netG.eval()
    out_path = 'training_results/SRF_upsacle=' + str(UPSCALE_FACTOR) + '/'
    ...
    if epoch % 10 == 0 and epoch != 0:
        ...
        data_frame.to_csv(out_path + 'srf_upsacle=' + str(UPSCALE_FACTOR) + '_train_results.csv', index_label='Epoch')
